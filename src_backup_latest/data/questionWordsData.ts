...
export const MASTER_SENSEI_DATA: QuestionWordItem[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { q: "日本への出張は何日間ですか。", qh: "にほん へ の しゅっちょう は なんにちかん です か。", qr: "Nihon e no shucchou wa nannichikan desu ka?", qv: "Chuyến công tác Nhật Bản kéo dài mấy ngày?", a: "5日間の予定です。", ah: "ごにちかん の よてい です。", ar: "Gonichikan no yotei desu.", av: "Dự kiến diễn ra trong 5 ngày." }
    ]
  },
  {
  ...
  },
  {
    ...
    examples: [
      { q: "田中さんは何歳ですか。", qh: "たなか さん は なんさい です か。", qr: "Tanaka-san wa nansai desu ka?", qv: "Anh Tanaka bao nhiêu tuổi rồi?", a: "今年で28歳になりました。", ah: "ことし で にじゅうはっさい に なりました。", ar: "Kotoshi de nijuuhassai ni narimashita.", av: "Tôi đã tròn 28 tuổi trong năm nay." },
