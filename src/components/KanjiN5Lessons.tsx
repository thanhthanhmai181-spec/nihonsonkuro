...
export default function KanjiN5Lessons({ onGoBack }: KanjiN5LessonsProps) {
  ...
  const saveState = (
    ...
    const toSave = {
      learnedIds: Array.from(newLearned),
      streak: newStreak,
      lastStudyDate: newLastDate,
      reviews: newReviews,
      quizCorrect: newQuizCorrect !== undefined ? newQuizCorrect : quizScore.correct,
      quizTotal: newQuizTotal !== undefined ? newQuizTotal : quizScore.total,
    };
