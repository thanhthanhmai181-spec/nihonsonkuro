...
export default function GrammarN5Lessons({ onGoBack }: GrammarN5LessonsProps) {
  ...
  const saveProgress = (updates: {
    ...
    const STORAGE_KEY = "sonkuro_n5_grammar_progress_v1";
    const current = {
      viewedLessons: updates.viewedLessons !== undefined ? updates.viewedLessons : viewedLessons,
      dialoguesRead: updates.dialoguesRead !== undefined ? updates.dialoguesRead : dialoguesRead,
      quizResults: updates.quizResults !== undefined ? updates.quizResults : quizResults,
      rememberedFlashcards: updates.rememberedFlashcards !== undefined ? updates.rememberedFlashcards : rememberedFlashcards,
    };
