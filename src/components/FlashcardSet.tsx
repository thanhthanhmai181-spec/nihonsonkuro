      ...
      {displayedVocab.length === 0 ? (
        ...
        <div className="max-w-xl mx-auto space-y-6">
          ...
          <div 
            id="flashcard-deck"
            onClick={handleFlip}
            className="perspective-1000 w-full h-80 cursor-pointer group relative"
          >
            <motion.div
            ...
            >
              {/* CARD FRONT */}
              <div className="absolute inset-0 backface-hidden bg-gradient-to-br from-natural-soft via-white to-natural-sand rounded-[32px] p-8 flex flex-col justify-between overflow-hidden">
                ...
                <div className="text-center space-y-2 z-10">
                  <h1 className="text-4xl sm:text-5xl font-black text-natural-deep tracking-wide font-sans">
                    {currentWord.word}
                  </h1>
                  <p className="text-natural-muted font-mono text-sm tracking-wider">
                    {currentWord.reading}
                  </p>
                </div>
              ...
              {/* CARD BACK */}
              <div 
                className="absolute inset-0 backface-hidden bg-[#2D241E] rounded-[32px] p-8 flex flex-col justify-between overflow-hidden text-white"
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-center">
                    <h2 className="text-2xl sm:text-3xl font-black text-pink-400 tracking-tight">
                      {currentWord.meaning}
                    </h2>
                  </div>
                      ...
                      if (effective) {
                        return (
                          <>
                            ...
                            <p className="text-sm font-semibold tracking-wide font-sans">{effective.example}</p>
